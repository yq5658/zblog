...
public class QiNiuYunUtil {
    ...
    public static ResponseVo writeFile(CloudStorageConfigVo cloudStorageConfigVo, String filePath, byte[] uploadBytes){
        ...
        //...生成上传凭证，然后准备上传
        String accessKey = cloudStorageConfigVo.getAliyunAccessKeyId();
        String secretKey = cloudStorageConfigVo.getAliyunAccessKeySecret();
        String bucket = cloudStorageConfigVo.getAliyunBucketName();
